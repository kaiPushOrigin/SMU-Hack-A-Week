  ...
  //  var map;
    ...
    function map_initialize()
    {
        ...
        $.get("map_process.php", function (data) {
            $(data).find("marker").each(function () {
                 //Get user input values for the marker from the form
                  ...
                  create_marker(point, name, address, false, false, false, "'http://maps.google.com/mapfiles/ms/icons/blue-dot.png'");
            });
        }); 
        ...
        google.maps.event.addListener(map, 'rightclick', function(event) {
            ...
            create_marker(event.latLng, 'New Marker', EditForm, true, true, true, "'http://maps.google.com/mapfiles/ms/icons/blue-dot.png'");
        });                             
    }
});
...
function save_marker(Marker, mName, mAddress, mType, replaceWin)
{
    ...
    $.ajax({
      ...
      success:function(data){
            ...
            Marker.setIcon('http://maps.google.com/mapfiles/ms/icons/blue-dot.png'); //replace icon
        },
        error:function (xhr, ajaxOptions, thrownError){
            alert(thrownError); //throw any errors
        }
