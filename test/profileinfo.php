...
<div class="progress progress-striped active">
  <div class="progress-bar"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 45%">
    <span class="sr-only">50% Complete</span>
	      ...
	      Name : <input type="text" name="name" id="name" class="form-control" placeholder="fullname" required autofocus>
    ...
    <footer>
      ...
      <p>&copy; 2014 SMUnity Inc. All Rights Reserved &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
    </footer>
